...
#
# The animation images come from Kenney and from POW Studios, and are available under an Attribution-only license.
# http://www.kenney.nl
# http://powstudios.com/
...
boltAnim0 = pyganim.PygAnimation([('testimages/female_stand.png', 200),
